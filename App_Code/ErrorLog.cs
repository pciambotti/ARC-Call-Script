...
public class ErrorLog
{
    ...
    static public void ErrorLog_Save(Exception ex, System.Web.UI.WebControls.DetailsView dv, String spModule, String spSource)
    {

        ErrorLog_Save(ex, dv, spModule, spSource, null, null, null);
    }
    static public void ErrorLog_Save(Exception ex, System.Web.UI.WebControls.DetailsView dv, String spModule, String spSource, String spPage)
    {
    ...
    static public void ErrorLog_Save(Exception ex, System.Web.UI.WebControls.DetailsView dv, String spModule, String spSource, String spPage, String spQuery, String spFullURL)
    {
        ...
        using (SqlConnection con = new SqlConnection(sqlStrPortal))
        {
            ...
            using (SqlCommand cmd = new SqlCommand("", con))
            {
                ...
                if (spSource == null) { spSource = "Ameriprise Admin"; }
