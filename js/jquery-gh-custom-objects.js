...
function GH_DatePicker_NoDefault() {
    $(document).ready(function() {
        // Date Picker
        // http://trentrichardson.com/examples/timepicker/
        $('.ghDatePicker').each(function(i, obj) {
...
function SelectDateDynamic(type, date1, date2) {
    $(document).ready(function() {
        // Today
        var d1 = new Date();
        var d2 = new Date();
        ...
        // If [Today] set the [Hour] to 1 hour ago
        $('#' + date1).datepicker('setDate', dA);
        $('#' + date2).datepicker('setDate', dB);
    });
}
...
function QualityControl(intid, actdate) {
    $(document).ready(function() {
        window.open('QualityControl.aspx?i=' + intid + '&a=' + actdate, actdate, "modal=yes,alwaysRaised=yes");
    });
}
function GH_Select() {
    $(document).ready(function() {
