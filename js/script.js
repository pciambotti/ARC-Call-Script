...
function Validate_A2() {
    ...
    Validate_A3_GoTo('A4'); // Default continue
    if ($("#cdCompany").val() == "DRTV") {
        ...
        $('input[name="rb3_designation"][value="158"]').prop('checked', true);
    } else if ($("#cdCompany").val() == "Harvey Telethon" || $("#cdCompany").val() == "Irma Telethon" || $("#cdTelethonMode").val() == "True" || rdValue == "YES" || rdValue == "NO") {
        ...
        if (rdValue == "") { rdValue = "NO"; }
    } else if ($("#cdSource").val() == "_Ansafone") {
        // rdValue = "NO";
        if (rdValue == "") { rdValue = "NO"; }
    } else if (rdValue == "YES") {
        var desArray = "35,109,158";
        var desSelected = "158";
        var desName = "Disaster Relief";

        $("#sectionA3_disaster_name").html(desName);
        $('input[name="rb3_designation"][value="' + desSelected + '"]').prop('checked', true);
        Designation_Toggle_Array("show", desArray);
...
function Validate_A3() {
    ...
    if (vfMsg.length > 0) {
        ...
        if (gtGoTo == "A4") {
            ...
            if ($("#cdCompany").val() == "DRTV") { $(".sectionA4_standard").hide(); $(".sectionA4_drtv").show(); } else { $(".sectionA4_standard").show(); $(".sectionA4_drtv").hide(); }
        }
        else if (gtGoTo == "A5") {
            Toggle_Field("section", "A3", "hide");
...
function Validate_A4() {
    ...
    if (!rdValue) {
        ...
        // If DRTV || Holiday we go to A45 not A5 || Sustainer
        // typeDNIS | .va
        ...
        if (typeDNIS == "DRTV" || rdDes == hDesignationID || $("#rdSustainer").val() == "YES") {
        ...
        var typeDNIS = $("#typeDNIS").val();
        if ($("#rdSustainer_txt").val() == "YES") { //if (typeDNIS == "DRTV" && rdValueDRTV == "DRTV_YES") {
...
function Validate_A48() {
    ...
    if (vfMsg.length > 0) {
        ...
        if (rdValue == "YES") {
            ...
            //}
            // Check No Address
            $("#ListBox96").val("49"); // Pledge - No Address
...
function Populate_A9() {
    ...
    if (sustainer) {
        ...
        var rdValue = $("#confirmation_02_template").html();
        ...
        var rdValue = $("#confirmation_01_template").html();
        if (rdValue.indexOf("{designation_name}") > -1) {
            $("#storedvalue_A9").html(rdValue);
        } else {
            var rdValue = $("#storedvalue_A9").html();
